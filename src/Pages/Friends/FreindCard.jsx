          ...
          <div>
               <div className="  h-[320px]  shadow-xl rounded-xl   relative">
                    ...
                    <Link to={`/otherProfile/profile/${data._id}`} className=" relative  mb-4">
                         <div className=" h-[180px]  w-[180px] rounded-full mx-auto border-4 border-[#0389C9]">
                              <img className=" rounded-full  relative   h-full  w-full" src={data.image} alt="" />
                         </div>
                         <p className=" capitalize text-center  text-lg relative  md:text-2xl font-medium  "> {data?.name} </p>
                         <p className=" text-center  text-base relative  md:text-lg font-medium "> {data?.address ?data?.address : 'New user' } </p>
                         <p className=" text-center  text-sm relative  md:text-base font-medium "> {data?.collage} </p>
