...
import { AiFillLike, AiOutlineClose, AiOutlineVideoCamera } from 'react-icons/ai';
               ...
               <div className=' relative'>
                    <div className=' w-full shadow-xl p-2  flex  justify-between items-center gap-2'>
                         <div className='   relative flex gap-2 items-center '>
                              <img className=' relative h-10 w-10 rounded-full object-cover' src="https://i.ibb.co/CMLBkdN/naim-kjadhb.jpg" alt="" />


                              <div className=' absolute w-3 h-3  left-8 -top-1  bg-[rgb(1,179,31)] rounded-full '></div>
                              <div className=' relative  space-y-0'>
                                   <h1 className='relative  text-base'>Shamim hossain</h1>
                         ...
                         <div className=' flex justify-center items-center gap-4'>
                              ...
                              <AiOutlineClose size={20} className='cursor-pointer  text-[#0389C9]'></AiOutlineClose>
                         </div>
                    </div>
                    <div></div>
                    <div className=' pb-5  boxshadow p-2   fixed w-[330px]   bottom-0 flex justify-around items-center gap-3 '>
                          ...
                          <div className=' bg-[#E4E6E8]  px-2 py-1 rounded-xl flex items-center gap-2 justify-between'>
                              <input    onFocus={()=>setOpen(true)} className=' w-full outline-none  bg-transparent ' type="text" placeholder='As' />
                                <BsFillEmojiNeutralFill size={20} className='cursor-pointer  text-[#0389C9]'></BsFillEmojiNeutralFill>
                          </div>
                          <div className=''>
                              <AiFillLike size={20} className='cursor-pointer  text-[#0389C9]'></AiFillLike>
                          </div>
                    </div>
