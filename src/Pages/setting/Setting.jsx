...
const Setting = () => {
     ...
     const handleSubmit = async () => {
          const fromData = { boi, media, address, Gender };
               ...
               <div>
                    <div className=" text-center w-full md:w-[900px] mx-auto">
                         ...
                         <div className="  w-full  py-2 px-4 rounded-lg bg-[#CCCFD2] flex justify-between  items-center gap-2  ">
                              ...
                              <div>
                                   <button className="  text-sm md:text-xl  rounded-lg px-4 py-2 bgColor">Change profile</button>
                              </div>
                         </div>
                         ...
                         <div>
                              <div className=" mt-10 ">
                                   ...
                                   <div className=" text-start">

                                        {
                                             userinfo?.media?.length > 0 ? <div>
                                                  ...
                                                  {
                                                       userinfo?.media?.map(item => <div className=" overflow-hidden  py-3 flex  items-center justify-start gap-2 md:gap-5" key={item?.mediaName}
                                                       >
                                                            <div>
                                                                 <TbWorld size={24} />
                                                            </div>
                                   ...
                                   <div className="  w-full rounded-lg  gap-4 grid md:grid-cols-3">
                              ...
                              <div className=" mt-10 ">
                                   ...
                                   <div>
                                        <textarea defaultValue={userinfo?.boi} className=" rounded-lg  p-2 w-full border outline-none  border-[#0389C9]" onChange={(e) => setBoi(e.target.value)} name="" id="" cols="30" rows="2" placeholder="add your boi"></textarea>
                                   </div>

                              </div>
                              <div className=" mt-10 ">
                                   <h1 className=" my-2 text-base text-start md:text-2xl font-medium"> Address</h1>
                                   <div>
                                        <textarea defaultValue={userinfo?.address} className=" rounded-lg  p-2 w-full border outline-none  border-[#0389C9]" onChange={(e) => setAddress(e.target.value)} name="" id="" cols="30" rows="2" placeholder="add location"></textarea>
                                   </div>
